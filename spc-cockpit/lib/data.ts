...
export const top10Prospects: Prospect[] = [
  { id: "1", nom: "EM Lyon", segment: "Commerce", cluster: "Lyon/RA", scoreBANT: 10, bant: { budget: 2.5, autorite: 2.5, besoin: 2.5, timing: 2.5 }, niveau: "Très chaud", priorite: "A", vague: 1, interlocuteur: "Resp. examens / Dir. opér. acad.", canal: "Appel + Email", statut: "Non contacté", action: "Appel sortant →" },
  { id: "2", nom: "IFSI CHU Lyon", segment: "Santé", cluster: "Lyon/RA", scoreBANT: 10, bant: { budget: 2.5, autorite: 2.5, besoin: 2.5, timing: 2.5 }, niveau: "Très chaud", priorite: "A", vague: 1, interlocuteur: "Dir. institut / Coord. examens", canal: "Email + Appel", statut: "Non contacté", action: "Email J+1 →" },
  { id: "3", nom: "IFSI CHU Lille", segment: "Santé", cluster: "Lille/HdF", scoreBANT: 10, bant: { budget: 2.5, autorite: 2.0, besoin: 2.5, timing: 2.5 }, niveau: "Très chaud", priorite: "A", vague: 1, interlocuteur: "Dir. institut / Coord. examens", canal: "Email + Appel", statut: "En cours", action: "Relance J+3 →" },
  { id: "4", nom: "Kedge Bordeaux", segment: "Commerce", cluster: "Bordeaux/NA", scoreBANT: 10, bant: { budget: 2.5, autorite: 2.5, besoin: 2.5, timing: 2.5 }, niveau: "Très chaud", priorite: "A", vague: 1, interlocuteur: "Dir. campus / Resp. examens", canal: "Email réseau", statut: "Non contacté", action: "Email réseau →" },
  { id: "5", nom: "Skema Lille", segment: "Commerce", cluster: "Lille/HdF", scoreBANT: 10, bant: { budget: 2.5, autorite: 2.5, besoin: 2.5, timing: 2.5 }, niveau: "Très chaud", priorite: "A", vague: 1, interlocuteur: "Resp. examens / Dir. opér.", canal: "Appel + Email", statut: "Non contacté", action: "Appel sortant →" },
  { id: "6", nom: "IFSI CHU Bordeaux", segment: "Santé", cluster: "Bordeaux/NA", scoreBANT: 10, bant: { budget: 2.5, autorite: 2.5, besoin: 2.5, timing: 2.5 }, niveau: "Très chaud", priorite: "A", vague: 1, interlocuteur: "Dir. institut / Resp. péda.", canal: "Email + Appel", statut: "Non contacté", action: "Email J+1 →" },
  { id: "7", nom: "ICN Nancy", segment: "Commerce", cluster: "Nancy/GE", scoreBANT: 10, bant: { budget: 2.0, autorite: 2.5, besoin: 2.5, timing: 2.5 }, niveau: "Très chaud", priorite: "A", vague: 1, interlocuteur: "Resp. examens / Resp. concours", canal: "Appel + Email", statut: "Non contacté", action: "Appel sortant →" },
  { id: "8", nom: "Grenoble EM", segment: "Commerce", cluster: "Lyon/RA", scoreBANT: 10, bant: { budget: 2.5, autorite: 2.5, besoin: 2.5, timing: 2.5 }, niveau: "Très chaud", priorite: "A", vague: 1, interlocuteur: "Coord. examens / Resp. concours", canal: "Appel + Email", statut: "RDV fixé", action: "Confirmer →" },
  { id: "9", nom: "CPGE Lyon", segment: "CPGE", cluster: "Lyon/RA", scoreBANT: 9.5, bant: { budget: 2.5, autorite: 2.5, besoin: 2.5, timing: 2.0 }, niveau: "Très chaud", priorite: "A", vague: 1, interlocuteur: "Dir. études prépa / Chef travaux", canal: "Email dir. études", statut: "Non contacté", action: "Email J+2 →" },
  { id: "10", nom: "CPGE Lille", segment: "CPGE", cluster: "Lille/HdF", scoreBANT: 9.5, bant: { budget: 2.5, autorite: 2.0, besoin: 2.5, timing: 2.0 }, niveau: "Très chaud", priorite: "A", vague: 1, interlocuteur: "Dir. études prépa / Chef travaux", canal: "Email dir. études", statut: "Non contacté", action: "Email J+2 →" },
];
