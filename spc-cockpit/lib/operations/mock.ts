...
// Affectations de la mission EX-2026-041 (id 5) — jeu de référence : total exact
// 66,25 h sur 10 surveillants, couverture 10/14 (≈ 71 %). Créneaux multi-slots
// pour les surveillants enchaînant plusieurs examens (moteur = somme non chevauchante).
export const mockAffectations: Affectation[] = [
  { id: 1, missionId: 5, surveillantId: 1, roleMission: "Coordinatrice",      statut: "Confirmé", presence: "Présent", salle: "A21", matin: true,  matinDebut: "08:00", matinFin: "14:00", apm: false }, // 6.00
  { id: 2, missionId: 5, surveillantId: 2, roleMission: "Surveillant volant", statut: "Confirmé", presence: "Présent", salle: undefined, matin: true, matinDebut: "08:00", matinFin: "12:15", apm: true, apmDebut: "14:15", apmFin: "17:00" }, // 7.00 — volant, salle à confirmer
  { id: 3, missionId: 5, surveillantId: 3, roleMission: "Surveillant salle",  statut: "Confirmé", presence: "Présent", salle: "C14", matin: true, matinDebut: "09:15", matinFin: "12:00", apm: false }, // 2.75
  { id: 4, missionId: 5, surveillantId: 4, roleMission: "Surveillant PMR",    statut: "Confirmé", presence: "Présent", salle: "E31", matin: true, matinDebut: "08:30", matinFin: "13:00", apm: true, apmDebut: "13:30", apmFin: "18:30" }, // 9.50
  { id: 5, missionId: 5, surveillantId: 5, roleMission: "Coordinatrice",      statut: "Confirmé", presence: "Présent", salle: "AMP", matin: false, apm: true, apmDebut: "13:00", apmFin: "19:00" }, // 6.00
  { id: 6, missionId: 5, surveillantId: 6, roleMission: "Surveillant salle",  statut: "Confirmé", presence: "Présent", salle: "A22", matin: true, matinDebut: "08:30", matinFin: "13:30", apm: false }, // 5.00
  { id: 7, missionId: 5, surveillantId: 7, roleMission: "Surveillant volant", statut: "Confirmé", presence: "Présent", salle: undefined, matin: true, matinDebut: "10:00", matinFin: "13:00", apm: false }, // 3.00 — volant, salle à confirmer
  { id: 8, missionId: 5, surveillantId: 8, roleMission: "Surveillant salle",  statut: "Confirmé", presence: "Présent", salle: "F11", matin: true, matinDebut: "08:00", matinFin: "13:00", apm: true, apmDebut: "13:15", apmFin: "17:30" }, // 9.25
  { id: 9, missionId: 5, surveillantId: 9, roleMission: "Surveillant salle",  statut: "Confirmé", presence: "Présent", salle: "F12", matin: true, matinDebut: "08:00", matinFin: "09:45", matinCreneaux: [{ debut: "08:00", fin: "09:45" }, { debut: "10:00", fin: "13:00" }], apm: true, apmDebut: "13:30", apmFin: "18:00" }, // 9.25
  { id: 10, missionId: 5, surveillantId: 10, roleMission: "Coordinateur",     statut: "Confirmé", presence: "Présent", salle: "E32", matin: true, matinDebut: "08:00", matinFin: "13:00", apm: true, apmDebut: "14:30", apmFin: "18:00" }, // 8.50
];
