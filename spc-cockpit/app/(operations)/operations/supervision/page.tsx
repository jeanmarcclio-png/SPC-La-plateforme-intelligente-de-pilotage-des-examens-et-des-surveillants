    ...
    <div className="svl">
      ...
      <div className="wrap">
        ...
        <div className="vitals">
          ...
          <div className="vital alert"><div className="k">Alertes actives</div><div className="n mono">{alertesN}</div><div className="g"><i style={{ width: `${Math.min(100, alertesN * 20)}%`, background: "var(--alert)" }} /></div><div className="sub">{sousEffectif.length} sous-effectif{sansSalle > 0 ? " · salles à compléter" : ""}</div></div>
        </div>
