            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <Link key={k.label} href={k.href} className="bg-white rounded-2xl p-4 border border-gray-100 shadow-sm active:opacity-70">
                  <div className="text-[30px] font-extrabold leading-none" style={{ color: k.color }}>{k.value}</div>
            ...
            {iaRec && (
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
                ...
                <div className="h-2 bg-gray-100 rounded-full overflow-hidden mb-3">
                  <div className="h-full rounded-full bg-[#1a6b7e]" style={{ width: `${iaProba}%` }} />
                </div>
          ...
          <div className="grid grid-cols-[1fr_252px] gap-4">
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <Link href="/campagnes" className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-200 bg-white text-[12.5px] text-gray-600 hover:bg-gray-50">Voir toutes les campagnes</Link>
              </div>
