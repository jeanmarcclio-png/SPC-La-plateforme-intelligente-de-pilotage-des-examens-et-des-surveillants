    ...
    <header className="h-[54px] bg-white border-b border-gray-200 flex items-center px-6 gap-3 flex-shrink-0">
      ...
      <div className="ml-auto flex items-center gap-2.5">
        ...
        <button
          ...
          onClick={() => window.dispatchEvent(new CustomEvent("copilote:open", { detail: "Aide-moi à utiliser Survéo : que puis-je faire depuis ce tableau de bord ? Quelles fonctionnalités sont disponibles ?" }))}
