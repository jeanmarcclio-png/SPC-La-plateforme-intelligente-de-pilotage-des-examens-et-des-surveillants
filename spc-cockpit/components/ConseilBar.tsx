export function ConseilBar({ text }: { text: string }) {
  return (
    <div className="bg-white border-t border-gray-200 px-6 py-2.5 flex items-center gap-3 flex-shrink-0">
      ...
      <button className="ml-auto flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-gray-200 bg-white text-[12px] text-gray-600 hover:bg-gray-50 whitespace-nowrap">
