  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4 space-y-3.5">
          ...
          <div className="grid grid-cols-3 divide-x divide-gray-100">
            {[
              ...
              },
              {
                icon: "📅",
                label: "Préparer RDV",
                prompt: `Aide-moi à préparer mon RDV avec ${prospect.nom} (${prospect.segment} · ${prospect.cluster}). Score BANT ${bantAuto}/10. Donne-moi 5 questions clés à poser, les 3 objections probables et comment les surmonter, et un pitch de 2 minutes sur la valeur Survéo.`,
              },
        ...
        {/* Données Survéo */}
        <div className="bg-gray-50 rounded-xl p-3.5 border border-gray-100">
          <div className="text-[13px] text-gray-600 font-bold uppercase tracking-wider mb-3">Données Survéo</div>
