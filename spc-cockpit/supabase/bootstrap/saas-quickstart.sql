-- ============================================================================
-- SPC — QUICK START SaaS multi-tenant (mode TRANSITION)
--
-- Script consolidé prêt à coller en UNE fois dans le SQL Editor Supabase
-- (région EU). Concatène les migrations 01→20 DANS L'ORDRE, en EXCLUANT
-- volontairement 12_rls-strict.sql (durcissement = phase 2, voir bas de fichier).
--
-- Toutes les migrations sont idempotentes : ré-exécuter ce script est sans
-- effet de bord. En mode transition, les policies restent permissives (tout
-- utilisateur authentifié voit les lignes) ; les écritures sont estampillées
-- org_id, prêtes pour le durcissement.
--
-- APRÈS ce script (optionnel, DÉMO uniquement, jamais en prod) :
--   supabase/seed/demo-saas-multitenant.sql
--
-- Généré par concaténation des fichiers supabase/migrations/*.sql — ne pas
-- éditer ici : modifier les migrations sources puis régénérer.
-- ============================================================================


-- ##########################################################################
-- ### migrations/01_operations-base.sql
-- ##########################################################################
...
-- ##########################################################################
-- ### migrations/02_missions-type-montant.sql
-- ##########################################################################
...
-- ##########################################################################
-- ### migrations/03_affectations-creneaux.sql
-- ##########################################################################
...
-- ##########################################################################
-- ### migrations/05_amenagements-factures-presence.sql
-- ##########################################################################
...
-- ##########################################################################
-- ### migrations/06_devis-lignes.sql
-- ##########################################################################
...
-- ##########################################################################
-- ### migrations/07_devis-salles-champs.sql
-- ##########################################################################
...
-- ##########################################################################
-- ### migrations/08_devis-equipe-frais.sql
-- ##########################################################################
...
-- ##########################################################################
-- ### migrations/09_devis-coefficient.sql
-- ##########################################################################
...
-- ##########################################################################
-- ### migrations/10_journal-sessions.sql
-- ##########################################################################
...
-- ##########################################################################
-- ### migrations/11_org-isolation.sql
-- ##########################################################################
-- ============================================================================
...
-- ##########################################################################
-- ### migrations/11b_org-id-completion.sql
-- ##########################################################################
...
-- ##########################################################################
-- ### migrations/13_surveillants-prenom-zone-dispo.sql
-- ##########################################################################
-- SPC Operations — v14
...
-- ##########################################################################
-- ### migrations/14_user-preferences.sql
-- ##########################################################################
...
-- ##########################################################################
-- ### migrations/16_org-parametres.sql
-- ##########################################################################
-- ============================================================================
...
-- ##########################################################################
-- ### migrations/18_surveillants-affectations-liens.sql
-- ##########################################################################
-- ============================================================================
...
-- ##########################################################################
-- ### migrations/19_rls-surveillant.sql
-- ##########################################################################
-- ============================================================================
...
-- ##########################################################################
-- ### migrations/20_onboarding-rpc.sql
-- ##########################################################################
-- ============================================================================
...
-- ============================================================================
-- PHASE 2 — DURCISSEMENT RLS (NE PAS jouer maintenant)
-- ============================================================================
-- Quand l'app tourne et que org_id est renseigné partout :
--   1. Backfill org_id sur les lignes legacy (bloc commenté de 11_org-isolation.sql)
--   2. Rattacher chaque utilisateur via organization_members
--   3. Jouer  supabase/migrations/12_rls-strict.sql
--   4. Jouer le bloc « HARDENING » de supabase/migrations/19_rls-surveillant.sql
--   5. Passer la variable d'env  SPC_ENFORCE_ROLES=1
-- Détails : spc-cockpit/DEPLOIEMENT.md §6.
-- ============================================================================
