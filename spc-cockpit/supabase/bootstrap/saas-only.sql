-- ============================================================================
-- SPC — SaaS UNIQUEMENT (migrations 15→20)
--
-- À utiliser quand le schéma Opérations (01→14) EXISTE DÉJÀ dans la base
-- (sinon utiliser saas-quickstart.sql). N'ajoute que les objets SaaS :
-- profiles, paramètres d'org, table sessions, liens surveillants/affectations,
-- rôle surveillant, RPC spc_create_organization.
--
-- 100 % idempotent (if not exists / create or replace / drop policy if exists) :
-- ré-exécutable sans effet de bord. NE contient PAS 12_rls-strict (phase 2).
-- ============================================================================
